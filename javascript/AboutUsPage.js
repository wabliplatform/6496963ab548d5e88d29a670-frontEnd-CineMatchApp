document.getElementById('iy19h').onclick = (event) => {
    ...
    event.preventDefault();
    { window.open('https://www.linkedin.com/in/konstantinos--petridis/',"_blank", 'width=600, height=600, location=yes');}};document.getElementById('i0jgxq').onclick = (event) => {
    event.preventDefault();
    { window.document.location = 'https://startbootstrap.com/solution/contact-forms';}};window.onload = () => {};