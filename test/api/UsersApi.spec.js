...
(function(root, factory) {
  ...
  describe('UsersApi', function() {
    ...
    describe('getByParamsusers', function() {
      it('should call getByParamsusers successfully', function(done) {
        //uncomment below and update the code to test getByParamsusers
        //instance.getByParamsusers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
